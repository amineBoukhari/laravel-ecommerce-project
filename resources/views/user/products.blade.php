<section class="product-tabs section-padding position-relative wow fadeIn animated">
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <select id="sort_price" class="form-select" aria-label="Sort by Price">
                <option value="asc" {{ request('sort') == 'asc' ? 'selected' : '' }}>Sort by Price: Low to High</option>
                <option value="desc" {{ request('sort') == 'desc' ? 'selected' : '' }}>Sort by Price: High to Low</option>
            </select>
        </div>
