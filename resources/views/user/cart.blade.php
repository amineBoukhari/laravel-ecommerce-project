...
<head>
    <meta charset="utf-8">
    <title>AmineMarket | My Cart</title>
            ...
            <div class="container">
              ...
              <div class="container">
                <div class="coupon-box">
                    ...
                    @endif
                    @if(session('success'))
                        <p style="color: green;">{{ session('success') }} Discount: {{ session('discount') }}%</p>
                    @endif
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="cart-action text-end">
                            <a class="btn" href="{{ route('user.shop') }}">
                                <i class="fi-rs-shopping-bag mr-10"></i> Continue Shopping
                            </a>
                        
                            @if(session('new_total'))
                            <a class="btn  mr-10 mb-sm-15" href="{{url('/stripe', session('new_total') )}}"><i class="fi-rs-shuffle mr-10"></i>Pay By Card</a>
                        @else
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount">
                                                        <strong><span class="font-xl fw-900">${{ $totalPrice }}</span></strong>
                                                    </td>
                                                </tr>
                                    
                                                @if(session('discount_amount'))
                                                <tr>
                                                    <td class="cart_total_label">Discount ({{ session('new_total') }}%)</td>
                                                    <td class="cart_total_amount text-success">
                                                        - ${{ session('discount_amount') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label"><strong>New Total</strong></td>
                                                    <td class="cart_total_amount">
                                                        <strong><span class="font-xl fw-900 text-danger">${{ session('new_total') }}</span></strong>
                                                    </td>
                                                </tr>
                                                @else
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount">
                                                        <strong><span class="font-xl fw-900 text-brand">${{ $totalPrice }}</span></strong>
                                                    </td>
                                                </tr>
                                                @endif
                                            </tbody>
