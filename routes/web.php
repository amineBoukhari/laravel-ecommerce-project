...
Route::get('/view_coupon', [AdminController::class, 'ViewCoupon'])->name('admin.coupons');
Route::post('/add_coupon', [AdminController::class, 'AddCoupon'])->name('admin.add_coupon');
Route::get('/delete_coupon/{id}', [AdminController::class, 'DeleteCoupon'])->name('admin.delete_coupon');
